#!/bin/bash
# VPL-GP RL (RLHF) training - UltraFeedback, 50000 selector verification
# TID 50001: uses UltraFeedback selector checkpoint from 50000 (hhst-ultrafeedback-50000-test)
# GPU 3, same pattern as docs: selector 50000 → RL 50001
...
nohup python -u federatedscope/llm/rlhf/main.py \
    --cfg cfg/vpl-gp/hrl-ultrafeedback-50001.yaml \
...
echo "Config: cfg/vpl-gp/hrl-ultrafeedback-50001.yaml"
