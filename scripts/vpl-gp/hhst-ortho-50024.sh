...
nohup python -u federatedscope/main.py \
    --cfg cfg/vpl-gp/hhst-ortho-50024.yaml \
...
echo "Config: cfg/vpl-gp/hhst-ortho-50024.yaml (VPL-GP with orthogonal loss, vpl_use_difference_only: True)"
