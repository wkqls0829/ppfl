...
nohup python -u federatedscope/llm/rlhf/main.py \
    --selector-cfg-file cfg/vpl/hhst.yaml \
    --cfg cfg/vpl/hrl.yaml \
    federate.save_to /hdd/hdd3/kjb/checkpoints/hhrl_rlhf_gemma_vpl_choice_gemma_fedbiscuit_u3_${tid}.ckpt \
    expname "vpl_hrl_t${tid}" \
    > outputs/${tid}.log 2>&1 &
