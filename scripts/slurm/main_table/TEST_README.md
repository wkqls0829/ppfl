...
sbatch scripts/slurm/main_table/test_cluster.sh gemma-2b fedvpagp

# Qwen 2 + FedDPO 테스트
sbatch scripts/slurm/main_table/test_cluster.sh qwen2 feddpo

# FedBiscuit 테스트
sbatch scripts/slurm/main_table/test_cluster.sh gemma-2b fedbiscuit
```
...
bash scripts/slurm/main_table/test_cluster.sh gemma-2b fedvpagp
# 또는
./scripts/slurm/main_table/test_cluster.sh gemma-2b fedvpagp
```
