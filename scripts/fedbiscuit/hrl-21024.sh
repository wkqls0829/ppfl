...
# Single GPU mode: GPU 3 (specified in config file)
...
nohup python -u federatedscope/llm/rlhf/main.py \
    --cfg cfg/fedbiscuit/hrl-21024.yaml \
...
echo "Config: cfg/fedbiscuit/hrl-21024.yaml (no variational elements, FedBiscuit algorithm)"
...
echo "GPU: 3 (specified in config file: device: 3)"
