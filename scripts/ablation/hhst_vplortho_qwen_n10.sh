...
echo "Model: Qwen 2"
echo "Checkpoint: ${CHECKPOINT_DIR}/hhrl_choice_qwen2_ablation_vplortho_n10_t${tid}.ckpt"
...
nohup python -u federatedscope/main.py \
    ...
    federate.save_to ${CHECKPOINT_DIR}/hhrl_choice_qwen2_ablation_vplortho_n10_t${tid}.ckpt \
    expname "vpl_ortho_qwen2_hhst_n10_t${tid}" \
    > outputs/${tid}.log 2>&1 &
