...
echo "Checkpoint: ${CHECKPOINT_DIR}/hhrl_choice_gemma_ablation_vplgp_n10_t${tid}.ckpt"
...
nohup python -u federatedscope/main.py \
    ...
    federate.save_to ${CHECKPOINT_DIR}/hhrl_choice_gemma_ablation_vplgp_n10_t${tid}.ckpt \
    expname "vplgp_no_ortho_hhst_n10_t${tid}" \
    > outputs/${tid}.log 2>&1 &
