...
# VPL Baseline (no GP prior, no orthogonal loss)
...
echo "Starting VPL Baseline - Selector Training"
echo "Task ID: ${tid}"
echo "Device: ${device}"
echo "Client count: 10"
echo "Config: cfg/vpl/hhst.yaml"
echo "Checkpoint: ${CHECKPOINT_DIR}/hhrl_choice_gemma_vpl_n10_t${tid}.ckpt"
