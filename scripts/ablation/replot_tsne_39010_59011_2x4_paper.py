...
def main():
    ...
    fig.text(label_x, y_top, "FedVPL", fontsize=16, fontweight="bold", va="center", ha="center")
    fig.text(label_x, y_bot, "FedVPA-GP", fontsize=16, fontweight="bold", va="center", ha="center")
