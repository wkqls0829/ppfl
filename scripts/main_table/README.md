...
```bash
# 개별 실험 실행
sbatch scripts/main_table/run_selector_gemma.sh fedvpagp 10 62130
...
```bash
# 개별 실험 실행
sbatch scripts/main_table/run_selector_qwen.sh fedvpagp 10 62230
...
```bash
# 개별 RL 실험 실행
sbatch scripts/main_table/run_rl_gemma.sh fedvpagp 10 63130 62130

# 모든 RL 실험 제출
bash scripts/main_table/submit_rl_gemma.sh
```

#### Qwen 2
```bash
# 개별 RL 실험 실행
sbatch scripts/main_table/run_rl_qwen.sh fedvpagp 10 63230 62230

# 모든 RL 실험 제출
bash scripts/main_table/submit_rl_qwen.sh
```
