...
nohup python -u federatedscope/main.py \
    --cfg cfg/fedvpl/hhst-30124.yaml \
...
echo "Config: cfg/fedvpl/hhst-30124.yaml (baseline: no GP prior, no orthogonal loss, client 50 version of 30024)"
echo "Hyperparameters: batch_size=8, lr=0.0001, KL_weight=0.1, variance_cap=-3.0"
